...
export default function AgencySwitcher() {
  ...
  return (
    <div className="mb-3 rounded-xl border border-[#3b3d38] bg-[#191a17] p-3">
      <div className="mb-2 flex items-center gap-2">
        ...
        {currentUser.rol === "SUPER_ADMIN" && (
          <button
            ...
            className="rounded-lg border border-amber-400/70 p-1 text-amber-300 transition hover:bg-amber-400 hover:text-stone-950"
      ...
      <select
        ...
        className="w-full rounded-lg border border-[#4a4b46] bg-[#252622] px-2 py-2 text-[11px] font-bold text-white outline-none focus:border-amber-400 disabled:opacity-60"
